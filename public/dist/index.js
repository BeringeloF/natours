...
})({"hhrAs":[function(require,module,exports) {
...
var _verifyPhoneNumberJs = require("./verifyPhoneNumber.js");
...
if (singUpForm) singUpForm.addEventListener("submit", async function(e) {
    e.preventDefault();
...
if (formElUser) formElUser.addEventListener("submit", async (e)=>{
    e.preventDefault();
    ...
    console.log(form);
    await (0, _updateSettingsJs.updateSettings)(form, "data");
});
if (formPassword) formPassword.addEventListener("submit", async (e)=>{
    e.preventDefault();
...
if (sendPhoneForm) sendPhoneForm.addEventListener("submit", async (e)=>{
    e.preventDefault();
    const code = document.querySelector("#code").value;
    await (0, _verifyPhoneNumberJs.sendCode)(code);
});

},{"./login.js":"7yHem","./mapbox.js":"3zDlz","./updateSettings.js":"l3cGY","./singUp.js":"49JON","./stripe.js":"10tSC","./verifyPhoneNumber.js":"hedtD"}],"7yHem":[function(require,module,exports) {
...
const logout = async ()=>{
    try {
        ...
        console.log(err);
        (0, _alertsJs.showAlert)("error", "Error loging out, try again later!");
    }
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5","./alerts.js":"6Mcnf"}],"gkKU3":[function(require,module,exports) {
...
const displayMap = (locations)=>{
    ...
    locations.forEach(function(marker) {
        ...
        new maplibregl.Marker().setLngLat(marker.coordinates).setPopup(popup).addTo(map);
    });
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49JON":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const stripe = Stripe("pk_test_51PUTQJRuPziSA3wgKKCf4mGMTlvNoEGCd6aQwHXUbg6ObfgTuCYlBD3SRT5tFg7J8PCSNxVKKAUNPV8BLc1sWZno00EWkw0JTu");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf"}],"hedtD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sendCode", ()=>sendCode);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hhrAs","f2QDv"], "f2QDv", "parcelRequireafa2")
